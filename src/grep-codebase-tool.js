...
// never did). `lineMatches` itself now lives in text-match.js (2026-09-07) so
// local-tool-client.js's search_tasks tool can reuse the identical matcher instead of a
// second, possibly-inconsistent implementation.

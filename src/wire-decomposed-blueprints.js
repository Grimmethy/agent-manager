...
// CORRECTION 2026-09-25: briefly moved to agent-manager-hub-tasks as part of S5e (the hub
// kernel move), then moved back here the same day -- agent-manager-hygiene's
// decompose-flask-blueprint.js (moved there in S4a) also requires this file's
// importPathFor(), a cross-plugin dependency neither plugin should have on the other.
// Stays in core permanently, same reasoning as hub-serial.js / hub-status-grounding.js:
// coordinator-sweep.js (agent-manager-hub-tasks) now reaches it via
// agent-manager/src/wire-decomposed-blueprints.js, the normal plugin-depends-on-core
// direction, same as agent-manager-hygiene already does.
//

...
// applyCandidateSplitAsHub (agent-manager-hub-tasks plugin) and local-draft.js's finalizeCandidateFulfillment. One switch, read by BOTH the draft (which routes) and

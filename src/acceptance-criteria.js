...
const SINGLE_FILE_SCOPE_RE = /\bonly\b[^.]*\b(?:file|modif|touch|chang)|\bno other (?:files?|paths?|lines?)\b|\bexclusively\b[^.]*\b(?:file|modif|touch|chang)|\bmust not (?:be modified|appear|change)\b|\b(?:does not|doesn't|should not|shouldn't|never)\s+appear\b/i;

...
### AC-17 · Async-ify resolveGraphPath and getConfig in src/config.js
Strength: Strong
Files: src/config.js
...
### AC-18 · Update all callers of getConfig and resolveGraphPath to await the now-async functions
Strength: Strong
